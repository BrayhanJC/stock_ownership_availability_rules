...

{
    ...
    "summary": "This app helps user to reserve sales stock and notify by email on stock reservation, also cancel after reserve stock, and can see different view like pivot view, bar graph, line chart, pie chart.",
    "description": """ 
